...
export default {
	...
	methods: {
		...
		createDiv() {
			...
			var imagInstEins = this.createInstance(test, { vertical: !this.vertical, oki: this.oki })
			var imagInstZwei = this.createInstance(test, { vertical: !this.vertical, oki: this.oki })
			var instance = this.createInstance(divSplit, { vertical: this.vertical, leftSlot: imagInstEins, rightSlot: imagInstZwei })
			instance.$mount()
